 ...
 *类说明：
 */
public class CdConsumerOtherQueue {
    ...
    public static void main(String[] args) {
        ...
        //实例化连接工厂
        connectionFactory = new ActiveMQConnectionFactory(CdConsumerOtherQueue.USERNAME,
                CdConsumerOtherQueue.PASSWORD, CdConsumerOtherQueue.BROKEURL);
