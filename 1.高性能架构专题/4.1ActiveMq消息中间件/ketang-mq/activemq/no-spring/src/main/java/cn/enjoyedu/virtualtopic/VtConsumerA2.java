package cn.enjoyedu.virtualtopic;
...
public class VtConsumerA2 {
    ...
    public static void main(String[] args) {
        ...
        //实例化连接工厂
        connectionFactory = new ActiveMQConnectionFactory(VtConsumerA2.USERNAME,
                VtConsumerA2.PASSWORD, VtConsumerA2.BROKEURL);
